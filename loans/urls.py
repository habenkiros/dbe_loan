...
urlpatterns = [
    ...
    path(
        'agent/conversations/',
        views_agent.agent_conversations_list_api,
        name='agent_conversations_list_api',
    ),
    path(
    ...
    path('upload_regions/', views.upload_regions, name='upload_regions'),
    path('upload_zones/', views.upload_zones, name='upload_zones'),
    path('upload_cities/', views.upload_cities, name='upload_cities'),
    path('upload_districts/', views.upload_districts, name='upload_districts'),
