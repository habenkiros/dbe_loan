...
def build_loan_agreement_body(loan_request) -> str:
    ...
    from loans.branding import institution_name, institution_short

    bank = institution_name()
    short = institution_short()

    return (
        f'{short} — LOAN AGREEMENT\n'
        f'{bank}\n'
        f'================================================\n\n'
        f'1. PARTIES\n'
        f'This Agreement is made on {today} at {branch}'
        f'{(" / " + district) if district else ""} between:\n'
        f'(a) {bank} (“{short}”, the Lender); and\n'
        ...
        f'2. FACILITY\n'
        f'{short} agrees to lend, and the Borrower agrees to take, a loan of ETB {_format_money(amount)} '
        ...
        f'Repayment shall follow the schedule confirmed in the staff hub '
        f'({instalments} instalment(s)). Interest accrues as shown on that schedule.\n\n'
        f'3. COLLATERAL AND LEGAL PAPERS\n'
        f'The Borrower charges in favour of {short} the collateral described on this file.\n'
        f'Government Collateral Restriction: {restriction_line}\n'
        f'Loan Collateral Power of Attorney: {poa_line}\n'
        f'{short} may enforce the security if the Borrower defaults.\n\n'
        ...
        f'collateral without {short}’s written consent.\n\n'
        f'5. DEFAULT\n'
        f'Failure to pay any instalment when due, or a material misstatement, entitles {short} '
        f'to demand the outstanding balance and to realise the security in accordance with '
        f'applicable Ethiopian law and {short} policy.\n\n'
