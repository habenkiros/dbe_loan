...
urlpatterns = [
    ...
    path('offline/ping/', offline_views.offline_ping, name='offline_ping'),
    path('offline/shell/', offline_views.offline_shell, name='offline_shell'),
    path('offline/setup/', offline_views.offline_phone_setup, name='offline_setup'),
    path('offline/ca.crt', offline_views.offline_ca_certificate, name='offline_ca'),
